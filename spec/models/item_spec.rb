...
describe Item, type: :model do
  ...
  describe "class methods" do
    it "#most_popular" do
      ...
      expect(Item.most_popular.first.name).to eq(bike.name)
      expect(Item.most_popular.first.total_quantity).to eq(21)
      expect(Item.most_popular[1].name).to eq(tire.name)
      expect(Item.most_popular[1].total_quantity).to eq(12)
      expect(Item.most_popular.last.name).to eq(helmet.name)
      expect(Item.most_popular.last.total_quantity).to eq(4)
